# v0.5.3 — Smart Clean Results Layout + Ad Flow

- Smart Clean result categories are now full-width vertical cards instead of horizontal carousels.
- Dark neon result cards use explicit high-contrast text and controls.
- Storage Analyzer categories are full-width, readable, and remain tappable.
- Category, storage, and file-preview dialogs use the same readable dark visual system.

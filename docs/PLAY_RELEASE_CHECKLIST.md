...
- [ ] QA APK reports version `0.5.20-closedtest1-qa` / versionCode `41`.
- [ ] Manual `Play Closed Test AAB + APK` workflow passes `lintClosedTest`, signed AAB/APK build and binary verification.
- [ ] Play AAB reports package `com.mrzekai.depoakilli`, version `0.5.20-closedtest1` / `41`, sample ads, non-debuggable state and the existing upload certificate.

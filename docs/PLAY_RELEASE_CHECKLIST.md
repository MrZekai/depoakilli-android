...
- [ ] QA APK reports version `0.5.19-closedtest2-qa` / versionCode `40`.
- [ ] Manual `Play Closed Test AAB + APK` workflow passes `lintClosedTest`, signed AAB/APK build and binary verification.
- [ ] Play AAB reports package `com.mrzekai.depoakilli`, version `0.5.19-closedtest2` / `40`, sample ads, non-debuggable state and the existing upload certificate.
